...
parser.add_argument('-model_dir', type=str, default='models/29-10-fm-vae-synthetic-mix')
...
if os.path.isfile(mfile):
    ...
    if opt.warmstart == 1:
        prev_model = '/workspace/results/29-10-dnn-mix/model=fwd-cnn-layers=3-bsize=8-ncond=10-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-gclip=5.0-warmstart=0-seed=1-syntetic.step320000.model' 
