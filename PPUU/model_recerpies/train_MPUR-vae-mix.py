...
model_dir = '/workspace/models/policy_networks/MPUR-vae-mix'
model_path = '/workspace/results/23-10-vae-mix/model=fwd-cnn-vae-fp-layers=3-bsize=16-ncond=10-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-nz=32-beta=1e-06-zdropout=0.5-gclip=5.0-warmstart=1-seed=1.step20000.model'
