...
parser.add_argument('-model_dir', type=str, default='models/fm-vae-synthetic-mix')
...
if os.path.isfile(mfile):
    ...
    if opt.warmstart == 1:
        prev_model = '/workspace/results/24-10-vae-mix/model=fwd-cnn-vae-fp-layers=3-bsize=16-ncond=10-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-nz=32-beta=1e-06-zdropout=0.5-gclip=5.0-warmstart=1-seed=1.step24000.model' 
