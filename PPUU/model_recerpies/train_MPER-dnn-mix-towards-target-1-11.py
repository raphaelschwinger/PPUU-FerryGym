...
parser.add_argument('-mfile', type=str, default='/workspace/models/fm-vae-synthetic-mix/model=fwd-cnn-vae-fp-layers=3-bsize=16-ncond=10-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-nz=32-beta=1e-06-zdropout=0.5-gclip=5.0-warmstart=1-seed=1.step56000.model')
...
opt.model_file = f'{opt.model_dir}/policy_networks/MPER_dnn_mix-1-11/'
