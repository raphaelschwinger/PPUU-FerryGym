...
parser.add_argument('-model_dir', type=str, default='models/fm-vae-finetune')
...
parser.add_argument('-tensorboard_dir', type=str, default='models',
                    help='path to the directory where to save tensorboard log. If passed empty path' \
                         ' no logs are saved.')
parser.add_argument('-synthetic', type=float, default=0.01, help='fraction of synthetic training data')
...
if os.path.isfile(mfile):
    ...
    if opt.warmstart == 1:
        prev_model = '/workspace/results/23-10-dnn-mix/model=fwd-cnn-layers=3-bsize=16-ncond=10-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-gclip=5.0-warmstart=0-seed=1-syntetic.step60000.model' 
